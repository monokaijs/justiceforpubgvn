      ...
      <section className="player-hero">
        <div className="player-hero-grid page-width">
          <div className="player-hero-copy">
            ...
            <p className="interior-kicker">VIETNAM / PUBG ESPORTS</p>
          ...
          <div className="player-hero-visual"><span className="player-visual-number">{player.number}</span><Image src={player.image} alt={`${player.name} (${player.fullName}), official PUBG Esports player portrait`} width={500} height={500} priority /><div className="player-visual-caption"><span>OFFICIAL PUBG ESPORTS PORTRAIT</span><a href={player.imageSource} target="_blank" rel="noopener noreferrer"><DualLanguage vi="NGUỒN ẢNH ↗" en="IMAGE SOURCE ↗" /></a></div></div>
        </div>
      </section>
