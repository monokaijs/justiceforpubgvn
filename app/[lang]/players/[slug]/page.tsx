      ...
      <section className="player-hero">
        <div className="player-hero-grid page-width">
          <div className="player-hero-copy">
            ...
            <div className="player-hero-actions"><LocalizedAnchor className="profile-primary" href="#biography"><DualLanguage vi="ĐỌC TIỂU SỬ" en="READ BIOGRAPHY" /> <span>↓</span></LocalizedAnchor><LocalizedAnchor className="profile-secondary" href={player.youtube} target="_blank" rel="noopener noreferrer">YOUTUBE ↗</LocalizedAnchor></div>
          </div>
