...
const copy = {
  vi: {
    ...
    supportInfoBody: "Cloudflare Turnstile kiểm tra lượt ủng hộ mới để hạn chế bot. Mỗi địa chỉ IP chỉ được tính một lượt; trang lưu IP và tổng số lượt ủng hộ. Cookie trong trình duyệt giúp nhận biết lượt đã ủng hộ trong tối đa một năm.",
  ...
  en: {
    ...
    supportInfoBody: "Cloudflare Turnstile checks new support requests for bots. Each IP address can add one support; the site stores voting IPs and the total count. A browser cookie remembers a vote for up to one year.",
