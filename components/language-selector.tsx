...
function Flag({ language }: { language: Language }) {
  ...
  if (language === "ja") return <span className="language-flag language-flag-emoji" aria-hidden="true">🇯🇵</span>;
  if (language === "de") return <span className="language-flag language-flag-emoji" aria-hidden="true">🇩🇪</span>;
  if (language === "ms") return <span className="language-flag language-flag-emoji" aria-hidden="true">🇲🇾</span>;
  if (language === "fil") return <span className="language-flag language-flag-emoji" aria-hidden="true">🇵🇭</span>;
  if (language === "ru") return <span className="language-flag language-flag-emoji" aria-hidden="true">🇷🇺</span>;
...
export default function LanguageSelector() {
  ...
  const label = { vi: "Ngôn ngữ", th: "ภาษา", en: "Language", ko: "언어", zh: "语言", ja: "言語", de: "Sprache", ms: "Bahasa", fil: "Wika", ru: "Язык" }[language];
