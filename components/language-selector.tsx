...
function Flag({ language }: { language: Language }) {
  ...
  if (language === "ja") return <svg className="language-flag" viewBox="0 0 30 20" aria-hidden="true"><path fill="#fff" d="M0 0h30v20H0z"/><circle cx="15" cy="10" r="6" fill="#bc002d"/></svg>;
  if (language === "ru") return <svg className="language-flag" viewBox="0 0 30 20" aria-hidden="true"><path fill="#fff" d="M0 0h30v20H0z"/><path fill="#0039a6" d="M0 6.67h30v13.33H0z"/><path fill="#d52b1e" d="M0 13.33h30v6.67H0z"/></svg>;
  if (language === "id") return <svg className="language-flag" viewBox="0 0 30 20" aria-hidden="true"><path fill="#ce1126" d="M0 0h30v10H0z"/><path fill="#fff" d="M0 10h30v10H0z"/></svg>;
  if (language === "es") return <svg className="language-flag" viewBox="0 0 30 20" aria-hidden="true"><path fill="#c60b1e" d="M0 0h30v20H0z"/><path fill="#ffc400" d="M0 5h30v10H0z"/></svg>;
  if (language === "tl") return <svg className="language-flag" viewBox="0 0 30 20" aria-hidden="true"><path fill="#0038a8" d="M0 0h30v10H0z"/><path fill="#ce1126" d="M0 10h30v10H0z"/><path fill="#fff" d="M0 0l17.32 10L0 20z"/><circle cx="6" cy="10" r="2.2" fill="#fcd116"/></svg>;
...
export default function LanguageSelector() {
  ...
  return <div className="language-selector" ref={root}>
    <button className="language-trigger" type="button" aria-label={`${label[language]}: ${languageNames[language]}`} aria-haspopup="listbox" aria-controls="site-language-options" aria-expanded={open} onClick={() => setOpen(!open)} onKeyDown={(event) => {
    ...
    {open && <div className="language-menu" id="site-language-options" role="listbox" aria-label={label[language]}>
